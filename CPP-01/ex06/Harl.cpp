...
/*   Updated: 2024/08/22 15:09:01 by jteissie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Harl::complain(filter_level level)
{
	...
	for (std::vector<std::pair<filter_level, void (Harl::*)() > > ::iterator it = functionVector.begin();
...
void Harl::filter(std::string level)
{
	...
	switch (index[level]) {
		...
		case ERROR:
			...
			break;
		case DEFAULT:
			std::cout << "I do not know what to tell you!" << std::endl;
			break ;
		}
}
